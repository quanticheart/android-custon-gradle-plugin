...
- [gradle-create-plugin](https://www.baeldung.com/gradle-create-plugin)


#### Gradle Oficial Doc

- [custom_plugins](https://docs.gradle.org/current/userguide/custom_plugins.html)
- [sample_convention_plugins](https://docs.gradle.org/current/samples/sample_convention_plugins.html)
- [implementing_gradle_plugins](https://docs.gradle.org/current/userguide/implementing_gradle_plugins.html)
- [plugins](https://docs.gradle.org/current/userguide/plugins.html)
- [declaring_dependencies_between_subprojects](https://docs.gradle.org/current/userguide/declaring_dependencies_between_subprojects.html)
- [designing_gradle_plugins](https://docs.gradle.org/current/userguide/designing_gradle_plugins.html)